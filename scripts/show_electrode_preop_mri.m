...
mri_post=MRIread('/Users/fhlin/workspace/music_layer_seeg/subjects/s035_post/mri/orig.mgz'); %for MAC/Linux
...
%
xfm=etc_read_xfm('file_xfm','/Users/fhlin/workspace/music_layer_seeg/subjects/s035_post/tmp/register.dat'); %for MAC/Linux
...
file_mat='electrode_041819_114159.mat'; %electrode coordinates in post-op MRI
load(file_mat);
...
fprintf('\nmust load [%s] to locate electrodes in ***pre-op*** MRI!\n\n',sprintf('%s_s035.mat',fstem));
save(sprintf('%s_s035.mat',fstem),'electrode');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


etc_render_fsbrain('surf','orig','hemi','rh','subject','s035','vol',mri,'talxfm',(talxfm));
view(90,30);