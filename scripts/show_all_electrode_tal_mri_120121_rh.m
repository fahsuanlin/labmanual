...
file_label={
    'rh.Temporo-Parieto-Occipital Junctio.label';
    'rh.Early Auditory Corte.label';
    'rh.Auditory Association Corte.label';
    };

roi_stem={
    'rh.Temporo-Parieto-OccipitalJunctio';
    'rh.EarlyAuditoryCorte';
    'rh.AuditoryAssociationCorte';
};
