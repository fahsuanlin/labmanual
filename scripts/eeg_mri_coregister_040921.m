...
setenv('SUBJECTS_DIR','/Users/fhlin/workspace/sri_eegmri/subjects/'); %for MAC/Linux

%source space
file_source_fif='/Users/fhlin/workspace/sri_eegmri/subjects/040921/bem/040921-5-src.fif';

surf_outer_skin='/Users/fhlin/workspace/sri_eegmri/subjects/040921/bem/watershed/040921_outer_skin_surface';
surf_outer_skull='/Users/fhlin/workspace/sri_eegmri/subjects/040921/bem/watershed/040921_outer_skull_surface';
surf_inner_skull='/Users/fhlin/workspace/sri_eegmri/subjects/040921/bem/watershed/040921_inner_skull_surface';

%electrodes
file_hsp='../digitizer/subj-001_shape.hsp';
file_elp='../digitizer/subj-001_elec.elp';

file_elec_name='../digitizer/subj-001_shape.hsp';
file_elec_loc='../digitizer/subj-001_elec.elp';


n_eeg=32; %this one is hard-coded here. But it should be determined automatically from files in the future. 


eeg_output_name='eeg_fwd_prep_040921.mat';
...
if(exist(eeg_output_name))
    ...
    if(exist('points'))
        ...
        points=etc_read_hspfile(file_hsp).*1e3;
        [elp_points elp_names]=etc_read_elpfile(file_elp);
        elp_points=elp_points.*1e3;

        elec.elecpos=cat(1,elp_points,points);
