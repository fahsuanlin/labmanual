...
hold on;
h_isk=patch('Vertices',verts_isk,'Faces',faces_isk,'Facealpha',0.2,'FaceColor',[1 1 0],'EdgeColor','none');
h_osk=patch('Vertices',verts_osk,'Faces',faces_osk,'Facealpha',0.2,'FaceColor',[0 1 1],'EdgeColor','none');
