...
data_path={
    '/Users/fhlin/workspace/seeg/s026/fmri_data/unpack/bold/032';
    };

reg_path={
    '/Users/fhlin/workspace/seeg/s026/fmri_data/unpack';
    };

mc_file='/Users/fhlin/workspace/seeg/s026/fmri_analysis/mc_regressor.mat';
...
file_register='/Users/fhlin/workspace/seeg/s026/fmri_data/unpack/register.dat';

file_aseg={
    'native_hippo_regressors_hippo_left.mat';
    'native_hippo_regressors_hippo_right.mat';
    };
...
output_stem={
    'hippo_fconn_native_vol_aseg_032124';
    };
    ...
    for f_idx=1:length(fstem)
        ...
        for d_idx=1:length(subject)
            ...
            if(flag_fe)
                ...
                fn=sprintf('%s/regressor_wm_ventrical_032.mat',reg_path{d_idx});
                if(exist(fn))
                    D_reg=[];
                    load(fn);
