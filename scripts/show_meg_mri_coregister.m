...
load(meg_output_name);
elec.elecpos=points;
elec.label=points_label;
for i=1:157 elec.label{i}=''; end;
...
%save for MG solution
%save(meg_output_name,'faces_isk','faces_osk','faces_osc','verts_isk','verts_osk','verts_osc','points','src','points_label');
