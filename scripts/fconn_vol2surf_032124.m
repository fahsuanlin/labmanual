...
file_in={
    ...
    '/Users/fhlin/workspace/seeg/s026/fmri_analysis/hippo_fconn_native_vol_aseg_032124_hippo_left-anat.nii';
    };
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for d_idx=1:length(file_in)
    ...
    [pathname,filename,ext]=fileparts(file_in{d_idx});
    fn0=sprintf('%s',file_in{d_idx});
    ...
    fn_out=sprintf('%s_2_%s_%s',source_subject,target_subject,file_output{d_idx});
