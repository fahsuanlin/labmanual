...
headerFile = {
    '../eeg_raw/inside01.vhdr';
    '../eeg_raw/inside02.vhdr';
    '../eeg_raw/inside03.vhdr';
    };

markerFile={
    '../eeg_raw/inside01.vmrk';
    '../eeg_raw/inside02.vmrk';
    '../eeg_raw/inside03.vmrk';
    };
...
flag_bcg=    [1 1 1]; %BCG artifact suppression
