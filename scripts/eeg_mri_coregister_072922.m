...
setenv('SUBJECTS_DIR','/Users/fhlin/workspace/eegmri_emotion/subjects/'); %for MAC/Linux

%source space
file_source_fif='/Users/fhlin/workspace/eegmri_emotion/subjects/s015/bem/s015-5-src.fif';

%surf_outer_skin='/Users/fhlin/workspace/eegmri_emotion/subjects/s015/bem/watershed/s015_outer_skin_surface';
surf_outer_skull='/Users/fhlin/workspace/eegmri_emotion/subjects/s015/bem/watershed/s015_outer_skull_surface';
surf_inner_skull='/Users/fhlin/workspace/eegmri_emotion/subjects/s015/bem/watershed/s015_inner_skull_surface';
surf_outer_skin='/Users/fhlin/workspace/eegmri_emotion/subjects/s015/surf/lh.seghead.tri';

%electrodes
file_elec_loc='../digitizer/20220923_Digitize2.pos';
n_eeg=32; %this one is hard-coded here. But it should be determined automatically from files in the future. 


eeg_output_name='eeg_fwd_prep_072922.mat';
...
if(exist(eeg_output_name))
    ...
    if(exist('points'))
        ...
        [ch_names, x,y,z]=etc_read_posfile(file_elec_loc,'n_headerline',1);
        points(:,1)=x;
        points(:,2)=y;
        points(:,3)=z;
    ...
    [ch_names, x,y,z]=etc_read_posfile(file_elec_loc,'n_headerline',1); %x, y, z in cm
    points(:,1)=x;
    points(:,2)=y;
    points(:,3)=z;
